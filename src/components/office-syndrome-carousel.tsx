            ...
            <div className="text-center max-w-xl mx-auto">
              <>
                <Image
                  ...
                  src="/assets/products/IMG_0506.PNG"
                ...
                <div className="px-5 ">
                  ...
                  <p className="font-semibold text-sm mt-[5px]">
                    ...
                    <br /> คุณอาจจะมีอาการปวดล้าบริเวณต่าง ๆ เช่น แขน คอ ไหล่
                    หลัง ขา เข่า ตา ข้อมือ
                  </p>
    ...
    <div ref={cardRef} className="overflow-hidden mt-[30px]">
      ...
      <div className="flex item-center justify-center py-4">
        <button
          ...
          className="btn-primary w-[45px] mr-[12px]"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
          ...
          >
            <path
              d="M10.1133 3.42812C9.42746 3.22315 8.67064 3.08913 7.83499 3.08913C4.0588 3.08913 1 6.14792 1 9.92412C1 13.7082 4.0588 16.767 7.83499 16.767C11.6112 16.767 14.67 13.7082 14.67 9.932C14.67 8.52874 14.2443 7.22008 13.519 6.13216M8.81254 1L11.0909 3.61732L8.43414 5.55666"
              stroke="white"
              stroke-width="1.18252"
        ...
        <Link href="/summary/therapist">
          <button className="btn-primary w-[200px] mr-[12px]">
            กดเพื่อรักษาต่อ
          </button>
        </Link>
        <button className="btn-primary w-[45px]" onClick={handleShare}>
          ...
          >
            <path
              d="M8.15 6.85L13.48 1.52M14 4.12V1H10.88M6.85 1H5.55C2.3 1 1 2.3 1 5.55V9.45C1 12.7 2.3 14 5.55 14H9.45C12.7 14 14 12.7 14 9.45V8.15"
              stroke="white"
              stroke-width="1.5"
              stroke-linecap="round"
              stroke-linejoin="round"
