...
export default function ImageGallery() {
    return (
        <div>
            <div className="w-full bg-[#7D9ED3] bg-opacity-3 h-[375px]"></div>
            <div className="flex">
                <Image className="w-1/3 h-[130px] bg-[#89abe3] bg-opacity-3" src="" alt="" width={130} height={130} />
                <Image className="w-1/3 h-[130px] bg-[#89abe3]" src="" alt="" width={130} height={130} />
                <Image className="w-1/3 h-[130px] bg-[#89abe3] bg-opcacity-3" src="" alt="" width={130} height={130} />
            </div>
            <div className="flex items-center pl-[22px] mt-[30px]">
                <h1 className="font-[#3E3E6B] text-[20px] font-bold">Porgee physio</h1>
